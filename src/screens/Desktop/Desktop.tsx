...
export const Desktop = ({ isVisible }: { isVisible: boolean }): JSX.Element => {
  ...
  return (
    <div className="bg-[#FFFFFF] flex flex-row justify-center w-full font-inter px-4 xl:px-8">
      <div className="bg-[#FFFFFF] w-full max-w-[1440px] xl:max-w-[1720px] 2xl:max-w-[1920px] relative">
        {/* Fixed Navigation */}
        <header
          data-aos="slide-down"
        ...
        <section
          ref={heroRef}
          className="pt-[100px] px-4 sm:px-8 md:px-12 lg:px-16 xl:px-24 2xl:px-32 pb-20 flex relative overflow-hidden"        >
